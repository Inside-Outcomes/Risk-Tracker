...
namespace RiskTracker.Reports {
  public class AdhocReport {
    ...
    private static Classifier[] allClassifiers = new Classifier[] {
      ...
      make("demographics.AgeBracket", "Age", (c, n) => Reports.ageBracket(c.Demographics.Dob)),
    ...
    public static void buildCSV(StreamWriter csv, Guid orgId, Guid projId, Guid? locId, string field, DateTime? startDate, DateTime? endDate) {
